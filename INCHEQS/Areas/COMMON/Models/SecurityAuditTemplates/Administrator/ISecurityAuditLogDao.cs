...
namespace INCHEQS.Areas.COMMON.Models.SecurityAuditTemplates
{
    public interface ISecurityAuditLogDao
    {
        ...
        string SecurityProfile_EditTemplate(SecurityProfileModel before, SecurityProfileModel after, string TableHeader, FormCollection col);
        ...
        GroupProfileModel CheckGroupMasterUserID(string groupId, string User);
