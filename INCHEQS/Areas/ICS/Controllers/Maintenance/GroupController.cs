            ...
            try {
                ...
                if ((errorMessages.Count > 0)) {
                    ...
                    if ("N".Equals(systemProfile)) {
                        groupDao.CreateGroupMaster(col, CurrentUser.Account.BankCode, CurrentUser.Account.UserId, CurrentUser.Account.SpickCode, CurrentUser.Account.UserId);
                        ...
                        groupDao.CreateGroupMasterTemp(col, CurrentUser.Account.UserId, CurrentUser.Account.BankCode, CurrentUser.Account.SpickCode, CurrentUser.Account.UserId);
