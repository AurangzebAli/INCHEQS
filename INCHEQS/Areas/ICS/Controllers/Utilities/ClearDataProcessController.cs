...
namespace INCHEQS.Areas.ICS.Controllers.Utilities
{
    ...
    public class ClearDataProcessController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            auditTrailDao.SecurityLog("Access ICS Clear Data Process", "", TaskIds.ClearDataProcess.INDEX, CurrentUser.Account);
            return View();
        }
        ...
        public ActionResult Delete(FormCollection collection)
        {
            if (collection != null & collection["deleteBox"] != null)
            {
                ...
                foreach (string arrResult in arrResults)
                {
                    ...
                    auditTrailDao.SecurityLog("ICS Clear Data Process - Primary Id: "  + arrResult, "", TaskIds.ClearDataProcess.INDEX, CurrentUser.Account);
                }
            }
            else
