...
{
    public class GenerateCreditFileDao : IGenerateCreditFileDao
    {
        private readonly ApplicationDbContext dbContext;
        protected readonly ISystemProfileDao systemProfileDao;

        public GenerateCreditFileDao(ApplicationDbContext dbContext, ISystemProfileDao systemProfileDao)
        {
        ...
        public string GetLatestPostingBatchID(string bankcode)
        {
            ...
            dtbPostingStatus = dbContext.GetRecordsAsDataTableSP("spcgCPICSItemPostingStatusLatestBatchID", SqlParameterNext.ToArray());
        ...
        {
            GenerateCreditFileModel postingOBJ = new GenerateCreditFileModel();
            processdate = DateTime.ParseExact(processdate, "dd-MM-yyyy", CultureInfo.InvariantCulture).ToString("MM-dd-yyyy");
            ...
            postingOBJ.filePath = GetFileSourcePath(processname,bankcode);
            ...
            AddICSCPPostingStatus(postingOBJ, bankcode, processdate);
            AddICSCPPostingItems(postingOBJ, bankcode, processdate);
        }
        ...
        public void AddICSCPPostingStatus(GenerateCreditFileModel postingOBJ, string bankcode, string processdate)
        {
            ...
            sqlParameterNext.Add(new SqlParameter("@fldPostingFileDate", postFileDate));
            sqlParameterNext.Add(new SqlParameter("@fldPostingFileExt", postingOBJ.fileExt));
            ...
            sqlParameterNext.Add(new SqlParameter("@fldPostingFilePath", postingOBJ.filePath));
            sqlParameterNext.Add(new SqlParameter("@fldPreviousPostingBatch", postingOBJ.previousPostBatch));
            ...
            dbContext.GetRecordsAsDataTableSP("spciCPStatusICS", sqlParameterNext.ToArray());

        }
        public void AddICSCPPostingItems(GenerateCreditFileModel postingOBJ, string bankcode, string processdate)
        {
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
            ...
            dbContext.GetRecordsAsDataTableSP("spciCPItemICS", sqlParameterNext.ToArray());

        }

        public string GetFileSourcePath(string processname,string bankcode)
        {
            DataTable dt = new DataTable();
            string filePath = "";
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
        ...
        public DataTable PostedItemHistory(FormCollection collection)
        {
            ...
            return dbContext.GetRecordsAsDataTableSP("spcgCPICSPostedItems", sqlParameterNext.ToArray());
        ...
        public DataTable ReadyItemForPostingHistory(FormCollection collection)
        {
            ...
            return dbContext.GetRecordsAsDataTableSP("spcgCPICSReadyItemForPostingDetail", sqlParameterNext.ToArray());
        }

        public GenerateCreditFileModel GetCreditFilePath(string processname, string bankcode)
        {
            DataTable dt = new DataTable();
            string filePath = "";

            GenerateCreditFileModel GenerateCreditFileModel = new GenerateCreditFileModel();
            ...
            {
                DataRow row = dt.Rows[0];
                GenerateCreditFileModel.fldFileSource = row["fldInterfaceFileSourcePath"].ToString();
                GenerateCreditFileModel.fldFileDestination = row["fldInterfaceFileDestPath"].ToString();
                GenerateCreditFileModel.fldFileName = row["fldInterfaceFileName"].ToString();

            }
            return GenerateCreditFileModel;
        }
        ...
        public void UpdateCreditFileUploaded(FormCollection col, string uploadStatus)
        {
            ...
            dbContext.GetRecordsAsDataTableSP("spcuCreditFileUpload", sqlParameterNext.ToArray());
