...
namespace INCHEQS.Models.HostFile {
    public class HostFileDao : IHostFileDao{

        private readonly ApplicationDbContext dbContext;
        public HostFileDao(ApplicationDbContext dbContext) {
        ...
        public HostFileModel GetDataFromHostFileConfig(string taskId) {
            HostFileModel hostFileModel = new HostFileModel();
