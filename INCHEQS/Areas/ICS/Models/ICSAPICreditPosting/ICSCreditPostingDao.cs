...
{
    public class ICSCreditPostingDao : IICSCreditPostingDao
    {
        private readonly ApplicationDbContext dbContext;
        protected readonly ISystemProfileDao systemProfileDao;

        public ICSCreditPostingDao(ApplicationDbContext dbContext, ISystemProfileDao systemProfileDao)
        {
        ...
        public void GenerateNewBatches(string bankcode, string intUserId, string processdate, string Totalitems, string TotalAmount)
        {
            ...
            AddICSCPPostingStatus(postingOBJ, bankcode);
            AddICSCPPostingItems(postingOBJ, bankcode, processdate);
        }

        public void AddICSCPPostingStatus(PostingStatusModel postingOBJ, string bankcode)
        {
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
        ...
        public void AddICSCPPostingItems(PostingStatusModel postingOBJ, string bankcode, string processdate)
        {
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
        ...
        public DataTable ReadyItemForPostingHistory(FormCollection collection)
        {
            ...
            sqlParameterNext.Add(new SqlParameter("@IssuingBankCode", collection["row_IssuingBankCode"]));
