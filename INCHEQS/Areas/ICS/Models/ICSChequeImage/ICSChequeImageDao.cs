...
namespace INCHEQS.Areas.ICS.Models.ChequeImage  
{
    public class ICSChequeImageDao : IICSChequeImageDao
    {
        ...
        public DataTable GetImageByte(string uic)
        {
            ...
            string stmt = "select fldGFrontIMGCode as fldgfrontimgbt, fldGBackIMGCode as fldgbackimgbt, fldFrontIMGCode as fldfrontimgbt, fldBackIMGCode as fldbackimgbt,fldUVIMGCode as flduvimgbt  from tblicsmicrimage where fldUIC = @flduic";
        ...
        /*public DataTable GetImageName(string uic)
        {
