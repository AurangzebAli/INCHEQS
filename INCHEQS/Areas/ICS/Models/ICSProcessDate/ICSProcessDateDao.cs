...
{
    public class ICSProcessDateDao : IICSProcessDateDao
    {
        private readonly ApplicationDbContext dbContext;
        public ICSProcessDateDao(ApplicationDbContext dbContext)
        {
        ...
        public bool PerfromStartofDay(FormCollection col, AccountModel currentUser)
        {
            ...
            sqlParameterNext.Add(new SqlParameter("@userid", Convert.ToInt64(currentUser.UserId)));
