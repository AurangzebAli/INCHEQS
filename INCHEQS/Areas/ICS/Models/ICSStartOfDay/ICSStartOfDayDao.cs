...
namespace INCHEQS.Areas.ICS.Models.ICSStartOfDay
{
    public class ICSStartOfDayDao : IICSStartOfDayDao
    {
        private readonly ApplicationDbContext dbContext;
        public ICSStartOfDayDao(ApplicationDbContext dbContext)
        {
        ...
        public string getConfirmProcessDate()
        {
            ...
            if (confirmprocessdate.Rows.Count > 0)
            {
                ...
                confirmprocessDate = dt.ToString("yyyy-MM-dd");
            }
            else
            {
