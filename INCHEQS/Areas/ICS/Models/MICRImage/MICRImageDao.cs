...
{
    public class MICRImageDao : IMICRImageDao
    {

        private readonly ApplicationDbContext dbContext;


        public MICRImageDao(ApplicationDbContext dbContext)
        {
        ...
        public List<MICRImageModel> GetItemStatusListing(string bankCode, string cleardate, string Status)
        {
            DateTime dtcleardate;
            dtcleardate = Convert.ToDateTime(cleardate);
            cleardate = dtcleardate.ToString("yyyy-MM-dd");
            List<MICRImageModel> ItemList = new List<MICRImageModel>();
            ...
            try
            {
                ...
                {
                    MICRImageModel inwardreturnmodel = new MICRImageModel()
                    {
        ...
        {
            MICRImageModel micrOBJ = new MICRImageModel();
        ...
        public void AddMICRStatus(MICRImageModel irdOBJ, string bankcode)
        {
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
        ...
        #region Ali
        public void AddClearingDate(string ClearDate, string BankCode,String UserId)
        {
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
            sqlParameterNext.Add(new SqlParameter("@fldBankCode", BankCode));
            ...
            sqlParameterNext.Add(new SqlParameter("@fldCreateTimeStamp", DateUtils.formatDateToSql(DateTime.Now.ToString("dd-MM-yyyy"))));
            sqlParameterNext.Add(new SqlParameter("@fldUpdateUserID", UserId));
            sqlParameterNext.Add(new SqlParameter("@fldUpdateTimeStamp", DateUtils.formatDateToSql(DateTime.Now.ToString("dd-MM-yyyy"))));
            dbContext.GetRecordsAsDataTableSP("spciMICRAddClearingDate ", sqlParameterNext.ToArray());
        ...
        public MICRImageModel GetMICRStatus(string bankCode, string currentProcess, int ItemBatch)
        {
            MICRImageModel mICRImageModel = new MICRImageModel();
            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
            sqlParameterNext.Add(new SqlParameter("@fldBankCode", bankCode));
        ...
        public MICRImageModel ListAvailableMICRStatusItem(string BankCode)
        {
            MICRImageModel micrstatusModels = new MICRImageModel();
        ...
        public string ListFolderPathFrom(string processname, string bankcode)
        {
            DataTable dt = new DataTable();
            string filePath = "";
            ...
            {
                DataRow row = dt.Rows[0];
                filePath = row["fldInterfaceFileSourcePath"].ToString();

            }
            return filePath;
        }
        public string BroadCastProgressBar(string processname, string bankcode)
        {
            DataTable dt = new DataTable();
            string filePath = "";

            List<SqlParameter> sqlParameterNext = new List<SqlParameter>();
            sqlParameterNext.Add(new SqlParameter("@fldProcess", processname));
            
            dt = dbContext.GetRecordsAsDataTableSP("spcgInwardBroadCastProgressBar", sqlParameterNext.ToArray());
            if (dt.Rows.Count > 0)
            {
                DataRow row = dt.Rows[0];
                filePath = row["fldStatus"].ToString();

            }
            return filePath;
        }

        public string ListFolderPathTo(string processname, string bankcode)
        {
            DataTable dt = new DataTable();
            string filePath = "";
        ...
        public string ListFolderPathUpload(string processname, string bankcode)
        {
            DataTable dt = new DataTable();
            string filePath = "";
        ...
        public MICRImageModel GetDataFromMICRImportConfig(string taskId, string bankcode)
        {
            MICRImageModel micrImageModel = new MICRImageModel();
            ...
            {
                DataRow row = dt.Rows[0];
                micrImageModel.fldSystemProfileCode = row["fldSystemProfileCode"].ToString();
                micrImageModel.fldSystemProfileCode2 = row["fldSystemProfileCode2"].ToString();
                micrImageModel.fldDateSubString = Convert.ToInt32(row["fldDateSubString"]);
                micrImageModel.fldBankCodeSubString = Convert.ToInt32(row["fldBankCodeSubString"]);
                micrImageModel.fldDateSubStringCompleted = Convert.ToInt32(row["fldDateSubStringCompleted"]);
                micrImageModel.fldBankCodeSubStringCompleted = Convert.ToInt32(row["fldBankCodeSubStringCompleted"]);
                micrImageModel.fldFileExt = row["fldFileExt"].ToString();
                micrImageModel.fldProcessName = row["fldProcessName"].ToString();
                micrImageModel.fldPosPayType = row["fldPosPayType"].ToString();
                return micrImageModel;
            }
            return null;
        }
