...
namespace INCHEQS.Areas.OCS.Controllers.OutwardClearing.HostFiles
{
    public abstract class HostFileBaseOCSController : BaseController {
        ...
        protected HostFileOCSModel gHostFileModel { get; private set; }
        ...
        protected PageSqlConfig initializeBeforeAction() {
            ...
            try {
                ...
                systemProfileDao.Log("HostFileBaseOCSController/initializeBeforeAction error :" + ex.Message, CurrentUser.Account.Logindicator, CurrentUser.Account.LogPath, CurrentUser.Account.UserId, CurrentUser.Account.UserAbbr);
                throw new HttpException(Locale.AccessDenied);
            }
        }

        public HostFileBaseOCSController(IPageConfigDaoOCS pageConfigDao, IDataProcessDao dataProcessDao, IFileManagerDao fileManagerDao, IAuditTrailDao auditTrailDao, ISearchPageService searchPageService, ISystemProfileDao systemProfileDao, IHostFileOCSDao hostFileDao) {
