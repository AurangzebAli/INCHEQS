...
namespace INCHEQS.Areas.OCS.Controllers.OutwardClearing.HostFiles {
    ...
    public class GenerateDebitFileOCSController : HostFileBaseOCSController
    {
        ...
        public GenerateDebitFileOCSController(IPageConfigDaoOCS pageConfigDao , 
            IDataProcessDao dataProcessDao , IFileManagerDao fileManagerDao, IAuditTrailDao auditTrailDao, ISearchPageService searchPageService, ISystemProfileDao systemProfileDao, IHostFileOCSDao hostFileDao) : base(pageConfigDao, dataProcessDao, fileManagerDao, auditTrailDao, searchPageService, systemProfileDao, hostFileDao) {
        }
