...
namespace INCHEQS.Areas.OCS.Controllers.InwardClearing.AIFImport.Base
{
    public abstract class AIFImportBaseController : BaseController
    {
        ...
        public AIFImportBaseController(IPageConfigDao pageConfigDao, IDataProcessDao dataProcessDao, IFileManagerDao fileManagerDao, IAuditTrailDao auditTrailDao, ISearchPageService searchPageService, IAIFImportDao aifImportDao, FileInformationService fileInformationService, SequenceDao sequenceDao, ISystemProfileDao systemProfileDao)
        {
        ...
        public JsonResult Import(FormCollection col)
        {
            ...
            int dateSubString = gAIFImportModel.fldDateSubString;
            int bankCodeSubString = gAIFImportModel.fldBankCodeSubString;
