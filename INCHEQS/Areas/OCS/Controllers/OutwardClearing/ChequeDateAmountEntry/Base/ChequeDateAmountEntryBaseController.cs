...
namespace INCHEQS.Areas.OCS.Controllers.OutwardClearing.ChequeDateAmountEntry.Base
{
    ...
    namespace OutwardClearing
    {
        ...
        //[CustomAuthorize]
        public abstract class ChequeDateAmountEntryBaseController : BaseController
        {
            ...
            public ChequeDateAmountEntryBaseController(IPageConfigDaoOCS pageConfigDao,
            ...
            public virtual async Task<ActionResult> Index()
            {
                ...
                auditTrailDao.SecurityLog("Access Cheque Date & Cheque Amount Entry", "", staskid, CurrentUser.Account);
            ...
            public virtual async Task<ActionResult> SearchResultPage(FormCollection collection)
            {
                ...
                gQueueSqlConfigSearch.ViewOrTableName = "view_chequedateamountentrylistingsearch";
                //auditTrailDao.SecurityLog("Access Cheque Date & Cheque Amount Entry", "", staskid, CurrentUser.Account);
            ...
            public virtual async Task<ActionResult> ChequeVerificationPage(FormCollection collection)
            {
                ...
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Individual Item Pickup  (" + OutwardItemId + ")", "", staskid, CurrentUser.Account);
            ...
            public virtual async Task<ActionResult> ChequeDateAmountQueue(FormCollection collection)
            {
                ...
                await initializeBeforeAction();
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Start LockVerification Queue", "", staskid, CurrentUser.Account);
                ...
                //systemProfileDao.Log(DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss.fff") + ": End LockVerification"/*, CurrentUser.Account.UserAbbr*/, CurrentUser.Account.UserAbbr, CurrentUser.Account.Logindicator, CurrentUser.Account.LogPath, CurrentUser.Account.UserId, CurrentUser.Account.UserAbbr);
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : End LockVerification Queue", "", staskid, CurrentUser.Account);
                return View(chequeVerificationPageHtml);
            }
            ...
            public virtual async Task<ActionResult> NextCheque(FormCollection collection)
            {
                ...
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Access Next Cheque ", "", staskid, CurrentUser.Account);
            ...
            public virtual async Task<ActionResult> PrevCheque(FormCollection collection)
            {
                ...
                // add by shamil 20170616
                // Delete temp gif when see next check
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Access Previous Cheque ", "", staskid, CurrentUser.Account);
            ...
            public virtual async Task<ActionResult> ChequeHistory(FormCollection collection)
            {
                ...
                , "fldcreatetimestamp desc", "fldBankCode=@fldBankCode and fldTransNo = @fldTransNo", new[] { new SqlParameter("@fldBankCode", CurrentUser.Account.BankCode),
                    ...
                    auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Retrieve audit log ", "", staskid, CurrentUser.Account);
                    return PartialView("OutwardClearing/Modal/_ChequeHistoryPopup");
                }
            ...
            public virtual async Task<ActionResult> PrintCheque(FormCollection collection)
            {
                ...
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Generate Report For Cheque '" + reportModel.extentionFilename + "' in " + fileNameExtention, "", staskid, CurrentUser.Account);
            ...
            public virtual async Task<ActionResult> Close(FormCollection collection)
            {
                ...
                // add by shamil 20170616
                // Delete temp gif when see next check
                auditTrailDao.SecurityLog("[Cheque Date & Cheque Amount Entry] : Closed Verification", "", staskid, CurrentUser.Account);
