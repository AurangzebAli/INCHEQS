using INCHEQS.Areas.OCS.Controllers.Submission.Clearing.Base;
...
namespace INCHEQS.Areas.OCS.Controllers.Submission.Clearing
{

    public class ClearingController : ClearingBaseController
    {
