...
namespace INCHEQS.Areas.OCS.Controllers.Submission.ClearingSummary.Base
{
    public abstract class ClearingSummaryBaseController : BaseController {
        ...
        public ClearingSummaryBaseController(IClearingDao clearingDao, IPageConfigDaoOCS pageConfigDao, IDataProcessDao dataProcessDao, IFileManagerDao fileManagerDao, IAuditTrailDao auditTrailDao, ISearchPageService searchPageService, IMICRImageDao micrImageDao, FileInformationService fileInformationService, SequenceDao sequenceDao, ISystemProfileDao systemProfileDao) {
