...
{
    public class ChequeAmountEntryDao : IChequeAmountEntryDao
    {
        ...
        public ChequeAmountEntryDao(OCSDbContext dbContext, ISequenceDao sequenceDao, ICommonOutwardItemDao commonOutwardItemDao, IAuditTrailDao auditTrailDao, IClearingDao clearingDao)
        {
        ...
        public List<string> Validate(FormCollection col, AccountModel currentUser, string CheckConfirm)
        {
            ...
            if (CheckConfirm == "A")
            {
                ...
                else
                {
                    ...
                    {
                        if (col["new_fldtype"].ToString().Trim().Equals("2"))
                        {
                            if (col["new_fldissueraccno"].ToString().Equals("") || col["new_fldissueraccno"].ToString().Trim().Length != 20)
                            {
                    ...
                    if (col["new_fldbranchCode"] != null)
                    {
                        ...
                        {
                            err.Add("Invalid Bank Branch Code. Please enter correct Branch Code");
                        }
                    }
                    else
                    {
