...
namespace INCHEQS.Areas.OCS.Models.Clearing
{
    public interface IClearingDao
    {
        ...
        string GetCurrentStatus(string ItemID);
        ...
        string[] GetNumbers(ClearingDao.EnumSequenceCode sequenceCode, Int64 bintTotalNumberNeed);
        ...
        int ReturnMaxLength(ClearingDao.EnumSequenceCode sequenceCode);

        //'Get the Sequence Number of Clearing Batch for Multi Entity
        string[] GetNumbersForClearingBatch(ClearingDao.EnumSequenceCode sequenceCode, Int64 bintTotalNumberNeed, string strBankCode);
        ...
        string GetCurrentProcessCode(ClearingDao.EnumCurrentProcessCode CurrentProcess);
