...
{
    public class ClearingSummaryDao : IClearingSummaryDao
    {
        ...
        public ClearingSummaryDao(ApplicationDbContext dbContext, OCSDbContext ocsdbContext, DbJoinDao dbJoinDao, ISystemProfileDao systemProfileDao)
        {
        ...
        public KeyValuePair<string, List<SqlParameter>> GetSqlParameter(string sqlQuery, Dictionary<string, string> currentUserParams)
        {
            ...
            sqlParams.Add(new SqlParameter("@clearingBatch", ""));
            sqlParams.Add(new SqlParameter("@dateBatch", ""));
            sqlParams.Add(new SqlParameter("@ui", ""));
            sqlParams.Add(new SqlParameter("@clearingAgent", ""));
            sqlParams.Add(new SqlParameter("@currentProcess", ""));
            sqlParams.Add(new SqlParameter("@userId", ""));
            sqlParams.Add(new SqlParameter("@GWCClearingDate", ""));
