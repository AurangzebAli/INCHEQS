...
namespace INCHEQS.Areas.OCS.Models.InwardReturnICL
{
    public class InwardReturnICLDao : IInwardReturnICLDao
    {
        ...
        public InwardReturnICLModel GetIRDStatus(string bankCode, string currentProcess, int ItemBatch)
        {
            ...
            DataTable dt = dbContext.GetRecordsAsDataTableSP("spcgInwardReturnStatus", sqlParameterNext.ToArray());
        ...
        public List<string> GetInwardStatus(string bankCode, string currentProcess, int ItemBatch)
        {
            ...
            DataTable recordsAsDataTable = dbContext.GetRecordsAsDataTableSP("spcgInwardReturnStatus", sqlParameterNext.ToArray());
            
            List<string> InwardStatus = new List<string>();
            foreach (DataRow row in recordsAsDataTable.Rows)
            {
                InwardStatus.Add(row["fldIRDBatch"].ToString());
