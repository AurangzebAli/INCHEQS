...
{
    public class MicrRepairDao : IMicrRepairDao
    {
        ...
        public MicrRepairDao(OCSDbContext dbContext, ISequenceDao sequenceDao, ICommonOutwardItemDao commonOutwardItemDao, IAuditTrailDao auditTrailDao)
        {
        ...
        public void Confirm(FormCollection col, AccountModel currentUser, string taskId)
        {
            try
            {
                ...
                auditTrailDao.SecurityLog("Edit Item Info - Item Id : " + col["current_flditemid"] + " Before Update=> " + auditLogBefore, "", taskId, CurrentUser.Account);
                auditTrailDao.SecurityLog("Edit Item Info - Item Id : " + col["current_flditemid"] + " After Update=> " + auditLogAfter, "", taskId, CurrentUser.Account);
        ...
        public List<string> ValidateMicr(FormCollection col, AccountModel currentUser)
        {
            List<string> err = new List<string>();
            List<string> branchCode = BranchCode(col["new_fldBranchCode"].ToString(), col["new_fldBankCode"].ToString());
