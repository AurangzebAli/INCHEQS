...
{
    public class OCSDebitPostingDao : IOCSDebitPostingDao
    {
        private readonly ApplicationDbContext dbContext;
        protected readonly ISystemProfileDao systemProfileDao;

        public OCSDebitPostingDao(ApplicationDbContext dbContext, ISystemProfileDao systemProfileDao)
        {
        ...
        public string GetLatestPostingBatchID()
        {
            ...
            dtbPostingStatus = dbContext.GetRecordsAsDataTableSP("spcgDPOCSPostingStatusLatestBatchID", SqlParameterNext.ToArray());
        ...
        public void AddOCSDPPostingStatus(PostingStatusModel postingOBJ, string bankcode)
        {
            ...
            dbContext.GetRecordsAsDataTableSP("spciDPStatusOCS", sqlParameterNext.ToArray());
        ...
        public void AddOCSDPPostingItems(PostingStatusModel postingOBJ, string bankcode, string processdate)
        {
            ...
            dbContext.GetRecordsAsDataTableSP("spciDPItemOCS", sqlParameterNext.ToArray());
        ...
        public DataTable PostedItemHistory(FormCollection collection)
        {
            ...
            return dbContext.GetRecordsAsDataTableSP("spcgDPOCSPostedItems", sqlParameterNext.ToArray());
        ...
        public DataTable ReadyItemForPostingHistory(FormCollection collection)
        {
            ...
            return dbContext.GetRecordsAsDataTableSP("spcgDPOCSReadyItemForPostingDetail", sqlParameterNext.ToArray());
        }
    }
}