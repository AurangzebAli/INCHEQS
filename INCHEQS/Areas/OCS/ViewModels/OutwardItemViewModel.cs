...
namespace INCHEQS.Areas.OCS.ViewModels {
    public class OutwardItemViewModel
	{

        public string pageTitle { get; set; }

        public bool lockedCheque { get; set; }
        ...
        public string creditpoststatus { get; set; }
        public string creditchequeamount { get; set; }
