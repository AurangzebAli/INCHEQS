...
namespace INCHEQS.Controllers.Api
{
    ...
    public class SignatureController : BaseController {
        ...
        public async Task<JsonResult> List(string accountNo) {
        ...
        public async Task<JsonResult> RulesList(string accountNo) {
            List<SignatureInfo> signatureRuleList = await signatureDao.GetSignatureRulesAsync(accountNo);
        ...
        public async Task<JsonResult> GetCheckedSignature(string itemId) {
            List<SignatureInfo> imageNoList = await signatureDao.GetCheckedSignatureAsync(itemId);
