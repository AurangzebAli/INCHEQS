...
--Create View
--------------------------------------------------------------
DROP VIEW [dbo].[View_TransactionType]
Go
CREATE VIEW [dbo].[View_TransactionType]
AS
SELECT        *,fldTransactionType as fldIdforDelete, (SELECT ReportTitle FROM tblReportPageConfig WHERE (DatabaseViewId = 'View_TransactionType')GROUP BY ReportTitle) AS ReportTitle
FROM            dbo.tblCTCSTransactionType
GO
...
DECLARE @menuTitle varchar(100) = 'Transaction Type';
DECLARE @taskDesc varchar(100) = 'Maintenance - Transaction Type';
DECLARE @taskDescNew varchar(100) = 'Maintenance - Transaction Type (New)';
DECLARE @taskDescEdit varchar(100) = 'Maintenance - Transaction Type (Edit)';
DECLARE @taskDescDelete varchar(100) = 'Maintenance - Transaction Type (Delete)';
DECLARE @mainMenuOrder int = 9;
DECLARE @subMenuOrder int = 22;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_TransactionType';

DECLARE @parentTaskId varchar(100) = '102000';
DECLARE @taskId varchar(100) = '102270';
DECLARE @new varchar(100) = '102271';
DECLARE @edit varchar(100) = '102272';
DECLARE @delete varchar(100) = '102274';

------------------------------------------------------------------------
-- Transaction Type
------------------------------------------------------------------------
DELETE FROM [tblTaskMaster] WHERE [fldTaskId] = @taskId
INSERT [dbo].[tblTaskMaster] ([fldBranchIndicator], [fldTaskId], [fldParentTaskID], [fldSubMenuTaskID], [fldMenuType], [fldMenuDesc], [fldButtonType], [fldSeqNo], [fldSearchFlag], [fldEditPage], [fldTaskType], [fldMainMenu], [fldSubMenu], [fldMainSeq], [fldSubSeq], [fldMenuTitle], [fldPageTitle], [fldTaskDesc], [fldSearch], [fldAllowNew], [fldImgFileName], [fldEditFile], [fldWidth], [fldHeight], [fldListImage], [fldPageImage], [fldBrowsePage], [fldRecordStatus], [fldMvcUrl]) VALUES (N'H', @taskId, @parentTaskId, NULL, N'S', N'', N' ', NULL, N' ', N'', N'Menu Page', @mainMenu, @subMenu, @mainMenuOrder, @subMenuOrder, @menuTitle, N'', @taskDesc, N'Y', N'N', N'', N'', 780, 400, N'', N'', N'', 1, N'ICS/TransactionType')
...
(N'5', @taskId, @view, N'TransactionTypeDataset' ,N'~/Reports/ICS/TransactionTypePrint.rdlc', N'Transaction Type List',  N'TransactionTypeList',N'all',N'Y', 1)

INSERT [dbo].[tblReportPageConfig] ([ReportId], [TaskId], [DatabaseViewId], [DataSetName], [ReportPath], [ReportTitle], [exportFileName], [PrintReportParam],[IsEnabled], [Ordering]) VALUES 
(N'5', @taskId, @view, N'TransactionTypeDataset' ,N'~/Reports/ICS/TransactionTypePrint.rdlc', N'Transaction Type List',  N'TransactionTypeList',N'page',N'Y', 1)
...
INSERT [dbo].[tblSearchPageConfig] ([TaskId], [DatabaseViewId], [FieldId], [FieldIdSqlCondition], [FieldIdOrderBy], [FieldType], [FieldLabel], [FieldDefaultValue], [ValueTextQueryForOption], [PageTitle], [Length], [IsResultParam], [IsFilter], [IsResult], [IsReadOnly], [IsEnabled], [Ordering], [EntityCode], [BankCode]) VALUES (@taskId, @view, N'fldTransactionType', NULL, NULL, N'TextBox', N'Transaction Type', NULL, N'', @taskDesc, 999, N'Y', N'Y', N'Y', N'N', N'Y', -1, @bank, @bank)

INSERT [dbo].[tblSearchPageConfig] ([TaskId], [DatabaseViewId], [FieldId], [FieldIdSqlCondition], [FieldIdOrderBy], [FieldType], [FieldLabel], [FieldDefaultValue], [ValueTextQueryForOption], [PageTitle], [Length], [IsResultParam], [IsFilter], [IsResult], [IsReadOnly], [IsEnabled], [Ordering], [EntityCode], [BankCode]) VALUES (@taskId, @view, N'fldTransactionDesc', NULL, NULL, N'TextBox', N'Transaction Type Description', NULL, N'', @taskDesc, 999, N'N', N'Y', N'Y', N'N', N'Y', -1, @bank, @bank)
