...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_Verification1st]
GO
CREATE VIEW [dbo].[View_Verification1st]
AS
SELECT DISTINCT * FROM dbo.View_Verification 
WHERE 
fldInwardItemId NOT IN (SELECT fldInwardItemId FROM View_RejectReentryMaker) AND 
fldNonConfirmStatus IS NULL AND 
fldApprovalStatus IS NULL
GO
...
DECLARE @menuTitle varchar(100) = '1st Verification';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - 1st Verification';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 5;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_Verification1st';
...
DECLARE @taskId varchar(100) = '306220';
DECLARE @lock varchar(100) = '306221';
DECLARE @action varchar(100) = '306222';
DECLARE @approve varchar(100) = '306223';
DECLARE @return varchar(100) = '306224';
DECLARE @route varchar(100) = '306225';
DECLARE @pullOut varchar(100) = '306226';
DECLARE @repair varchar(100) = '306227';
DECLARE @printAll varchar(100) = '306228';
DECLARE @printSum varchar(100) = '306229';
--------------------------------------------------------------
