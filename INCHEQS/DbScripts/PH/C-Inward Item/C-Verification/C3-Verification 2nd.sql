...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_Verification2nd]
GO
CREATE VIEW [dbo].[View_Verification2nd]
AS
SELECT DISTINCT * FROM dbo.View_Verification 
WHERE 
fldInwardItemId NOT IN (SELECT fldInwardItemId FROM View_RejectReentryMaker) AND 
fldNonConfirmStatus IS NOT NULL AND fldNonConfirmStatus NOT IN('C','S')
GO
...
DECLARE @menuTitle varchar(100) = '2nd Verification';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - 2nd Verification';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 6;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_Verification2nd';
DECLARE @taskRole varchar(100) = 'Checker1';
...
DECLARE @taskId varchar(100) = '306230';
DECLARE @lock varchar(100) = '306231';
DECLARE @action varchar(100) = '306232';
DECLARE @approve varchar(100) = '306233';
DECLARE @return varchar(100) = '306234';
DECLARE @route varchar(100) = '306235';
DECLARE @pullOut varchar(100) = '306236';
DECLARE @repair varchar(100) = '306237';
DECLARE @printAll varchar(100) = '306238';
DECLARE @printSum varchar(100) = '306239';
--------------------------------------------------------------
