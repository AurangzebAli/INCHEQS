...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_Verification3rd]
GO
CREATE VIEW [dbo].[View_Verification3rd]
AS
SELECT DISTINCT * FROM dbo.View_Verification WHERE
fldInwardItemId NOT IN (SELECT fldInwardItemId FROM View_RejectReentryMaker) AND 
 fldNonConfirmStatus IN('C','S')
GO
...
DECLARE @menuTitle varchar(100) = '3rd Verification';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - 3rd Verification';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 7;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_Verification3rd';
...
DECLARE @taskId varchar(100) = '306240';
DECLARE @lock varchar(100) = '306241';
DECLARE @action varchar(100) = '306242';
DECLARE @approve varchar(100) = '306243';
DECLARE @return varchar(100) = '306244';
DECLARE @route varchar(100) = '306245';
DECLARE @pullOut varchar(100) = '306246';
DECLARE @repair varchar(100) = '306247';
DECLARE @printAll varchar(100) = '306248';
DECLARE @printSum varchar(100) = '306249';
--------------------------------------------------------------
