...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_Band1]
GO
CREATE VIEW [dbo].[View_Band1]
AS
SELECT * FROM dbo.View_Verification
WHERE 
fldInwardItemId NOT IN (SELECT fldInwardItemId FROM View_RejectReentryMaker) AND 
(fldAmount >= (SELECT fldBandLBound FROM dbo.tblTaskBandLimit WHERE (fldTaskId = '306310'))) AND (fldAmount <= (SELECT fldBandUBound FROM dbo.tblTaskBandLimit AS tblTaskBandLimit_1 WHERE (fldTaskId = '306310')))
GO
...
DECLARE @menuTitle varchar(100) = 'Band 1';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Band 1';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 8;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_Band1';
...
DECLARE @taskId varchar(100) = '306310';
DECLARE @lock varchar(100) = '306311';
DECLARE @action varchar(100) = '306312';
DECLARE @approve varchar(100) = '306313';
DECLARE @return varchar(100) = '306314';
DECLARE @route varchar(100) = '306315';
DECLARE @pullOut varchar(100) = '306316';
DECLARE @repair varchar(100) = '306317';
DECLARE @printAll varchar(100) = '306318';
DECLARE @printSum varchar(100) = '306319';

DECLARE @lowBound float = 0;
DECLARE @UpBound float = 9999.99;
