...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_Band2]
GO
CREATE VIEW [dbo].[View_Band2]
AS
SELECT * FROM dbo.View_Verification
WHERE 
fldInwardItemId NOT IN (SELECT fldInwardItemId FROM View_RejectReentryMaker) AND 
(fldAmount >= (SELECT fldBandLBound FROM dbo.tblTaskBandLimit WHERE (fldTaskId = '306320'))) AND (fldAmount <= (SELECT fldBandUBound FROM dbo.tblTaskBandLimit AS tblTaskBandLimit_1 WHERE (fldTaskId = '306320')))
GO
...
DECLARE @menuTitle varchar(100) = 'Band 2';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Band 2';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 9;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_Band2';
...
DECLARE @taskId varchar(100) = '306320';
DECLARE @lock varchar(100) = '306321';
DECLARE @action varchar(100) = '306322';
DECLARE @approve varchar(100) = '306323';
DECLARE @return varchar(100) = '306324';
DECLARE @route varchar(100) = '306325';
DECLARE @pullOut varchar(100) = '306326';
DECLARE @repair varchar(100) = '306327';
DECLARE @printAll varchar(100) = '306328';
DECLARE @printSum varchar(100) = '306329';

DECLARE @lowBound float = 10000.00;
DECLARE @UpBound float = 99999.99;
