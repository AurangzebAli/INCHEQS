...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_Band3]
GO
CREATE VIEW [dbo].[View_Band3]
AS
SELECT * FROM dbo.View_Verification
WHERE 
fldInwardItemId NOT IN (SELECT fldInwardItemId FROM View_RejectReentryMaker) AND 
(fldAmount >= (SELECT fldBandLBound FROM dbo.tblTaskBandLimit WHERE (fldTaskId = '306330'))) AND (fldAmount <= (SELECT fldBandUBound FROM dbo.tblTaskBandLimit AS tblTaskBandLimit_1 WHERE (fldTaskId = '306330')))
GO
...
DECLARE @menuTitle varchar(100) = 'Band 3';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Band 3';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 10;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_Band3';
...
DECLARE @taskId varchar(100) = '306330';
DECLARE @lock varchar(100) = '306331';
DECLARE @action varchar(100) = '306332';
DECLARE @approve varchar(100) = '306333';
DECLARE @return varchar(100) = '306334';
DECLARE @route varchar(100) = '306335';
DECLARE @pullOut varchar(100) = '306336';
DECLARE @repair varchar(100) = '306337';
DECLARE @printAll varchar(100) = '306338';
DECLARE @printSum varchar(100) = '306339';

DECLARE @lowBound float = 100000.00;
DECLARE @UpBound float = 999999.99;
