...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_ReviewMine]
GO
CREATE VIEW [dbo].[View_ReviewMine]
AS
select distinct a.*,
...
FROM View_Verification a left outer join
...
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Review Mine';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 12;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_ReviewMine';
DECLARE @taskRole varchar(100) = '';
DECLARE @queueOrderBy varchar(100) = 'fldAccountDesc DESC, fldAmount DESC';
DECLARE @userParam varchar(100) = 'fldInvolvedUserId=@currentUserId';
DECLARE @lockCondition varchar(100) = '';

DECLARE @parentTaskId varchar(100) = '306000';
DECLARE @taskId varchar(100) = '306510';
DECLARE @printAll varchar(100) = '306511';
--------------------------------------------------------------
