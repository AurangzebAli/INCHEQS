...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_PullOutData]
GO
CREATE VIEW [dbo].[View_PullOutData]
AS
SELECT DISTINCT * FROM dbo.View_Verification WHERE fldNonConfirmStatus = 'P'
GO
...
DECLARE @menuTitle varchar(100) = 'Pull Out Data';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Pull Out Data';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 13;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_PullOutData';
...
DECLARE @taskId varchar(100) = '306520';
DECLARE @lock varchar(100) = '306521';
DECLARE @action varchar(100) = '306522';
DECLARE @approve varchar(100) = '306523';
DECLARE @return varchar(100) = '306524';
DECLARE @route varchar(100) = '306525';
DECLARE @pullOut varchar(100) = '306526';
DECLARE @repair varchar(100) = '306527';
DECLARE @printAll varchar(100) = '306528';
DECLARE @printSum varchar(100) = '306529';
--------------------------------------------------------------
