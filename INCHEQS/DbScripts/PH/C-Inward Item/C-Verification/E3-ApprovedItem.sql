...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_ApprovedItem]
GO
CREATE VIEW [dbo].[View_ApprovedItem]
AS
SELECT DISTINCT * FROM dbo.View_Verification WHERE fldApprovalStatus = 'A'
GO
...
DECLARE @menuTitle varchar(100) = 'Approved Item';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Approved Item';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 14;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_ApprovedItem';
...
DECLARE @taskId varchar(100) = '306530';
DECLARE @printAll varchar(100) = '306531';
DECLARE @printSum varchar(100) = '306532';
--------------------------------------------------------------
