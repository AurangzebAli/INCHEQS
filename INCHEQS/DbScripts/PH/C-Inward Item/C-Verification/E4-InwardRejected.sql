...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_InwardRejected]
GO
CREATE VIEW [dbo].[View_InwardRejected]
AS
SELECT * FROM  dbo.View_Verification
WHERE fldApprovalStatus='R'
GO
...
DECLARE @menuTitle varchar(100) = 'Inward Rejected';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Inward Rejected';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 15;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_InwardRejected';
...
DECLARE @taskId varchar(100) = '306540';
DECLARE @printAll varchar(100) = '306541';
DECLARE @printSum varchar(100) = '306542';
--------------------------------------------------------------
...
INSERT [dbo].[tblQueueConfig] ([fldId], [fldTaskId], [fldQueueName], [fldQueueDesc], [fldViewName], [fldOrderBy], [fldUserParamCondition], [fldAllowedAction], [fldTaskRole], [fldLockCondition], [fldEnable], [fldEntityCode], [fldBankCode]) VALUES (1, @taskId, @menuTitle, @taskDesc, @view, @queueOrderBy, @userParam ,@printAll+N','+@printSum , @taskRole ,@lockCondition , N'Y', @bank , @bank)
