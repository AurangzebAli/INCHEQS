...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_PendingBranch]
GO
CREATE VIEW [dbo].[View_PendingBranch]
AS
SELECT DISTINCT * FROM dbo.View_Verification WHERE fldNonConfirmStatus = 'B'
GO
...
DECLARE @menuTitle varchar(100) = 'Pending Branch Confirmation';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Pending Branch Confirmation';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 16;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_PendingBranch';
...
DECLARE @taskId varchar(100) = '306550';
DECLARE @lock varchar(100) = '306551';
DECLARE @action varchar(100) = '306552';
DECLARE @approve varchar(100) = '306553';
DECLARE @return varchar(100) = '306554';
DECLARE @route varchar(100) = '306555';
DECLARE @pullOut varchar(100) = '306556';
DECLARE @repair varchar(100) = '306557';
DECLARE @printAll varchar(100) = '306558';
DECLARE @printSum varchar(100) = '306559';
--------------------------------------------------------------
