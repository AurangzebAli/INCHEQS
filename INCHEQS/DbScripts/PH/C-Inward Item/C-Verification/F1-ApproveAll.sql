...
--create view
--------------------------------------------------------------
DROP VIEW [dbo].[View_ApproveAll]
GO
CREATE VIEW [dbo].[View_ApproveAll]
AS
...
DECLARE @menuTitle varchar(100) = 'Approve All';
DECLARE @taskDesc varchar(100) = 'Inward Clearing - Approve All';
DECLARE @mainMenuOrder int = 1;
DECLARE @subMenuOrder int = 17;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_ApproveAll';
DECLARE @taskRole varchar(100) = 'ApproveAll';
...
DECLARE @taskId varchar(100) = '306610';
DECLARE @approveAll varchar(100) = '306611';
DECLARE @printAll varchar(100) = '306612';
DECLARE @printSum varchar(100) = '306613';
--------------------------------------------------------------
...
VALUES (N'H', @approveAll, @parentTaskId, NULL, N'S', N'', N' ', NULL, N' ', N'', N'', N'', N'', 0, 0, N'', N'', @taskDesc+N' (Approve All)', N'N', N'N', N'', N'', 0, 0, N'', N'', N'', 1, N'ApproveAll')
