...
--create view
--------------------------------------------------------------
Drop View [dbo].[View_RejectedItemReport]
Go
CREATE VIEW [dbo].[View_RejectedItemReport]
AS
select * from View_AppInwardItem where fldItemStatus='Returned'
GO
...
DECLARE @menuTitle varchar(100) = 'Rejected Item Report';
DECLARE @taskDesc varchar(100) = 'Report - Rejected Item Report';
DECLARE @mainMenuOrder int = 7;
DECLARE @subMenuOrder int = 63;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_RejectedItemReport';
DECLARE @reportPath varchar(100) = '~//Reports/ICS/RejectedItemReport.rdlc';
DECLARE @reportTitle varchar(100) = 'RejectedItemReport';
DECLARE @fileName varchar(100) = 'RejectedItemRpt';
DECLARE @reportParam varchar(100) = '';
DECLARE @orientation varchar(100) = 'Landscape';

DECLARE @parentTaskId varchar(100) = '304000';
DECLARE @taskId varchar(100) = '304590';
--------------------------------------------------------------
--Update Taskmaster
--------------------------------------------------------------
