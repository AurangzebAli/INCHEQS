...
--create view
--------------------------------------------------------------
Drop View [dbo].View_ReturnItemSummaryReport
Go
CREATE VIEW [dbo].View_ReturnItemSummaryReport
AS
...
DECLARE @menuTitle varchar(100) = 'Summary of Return Items Report';
DECLARE @taskDesc varchar(100) = 'Report - Summary of Return Items Report';
DECLARE @mainMenuOrder int = 7;
DECLARE @subMenuOrder int = 63;

DECLARE @bank varchar(100) = '009';
DECLARE @view varchar(100) = 'View_ReturnItemSummaryReport';
DECLARE @reportPath varchar(100) = '~//Reports/ICS/SummaryReturnItemReport.rdlc';
DECLARE @reportTitle varchar(100) = 'ReturnItemSummaryReport';
DECLARE @fileName varchar(100) = 'ReturnItemSummaryRpt';
DECLARE @reportParam varchar(100) = '';
DECLARE @orientation varchar(100) = 'Landscape';

DECLARE @parentTaskId varchar(100) = '304000';
DECLARE @taskId varchar(100) = '304600';
--------------------------------------------------------------
--Update Taskmaster
--------------------------------------------------------------
