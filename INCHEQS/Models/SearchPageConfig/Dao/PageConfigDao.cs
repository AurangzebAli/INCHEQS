    ...
    public class PageConfigDao : IPageConfigDao {
       ...
       // private string strConn = ConfigurationManager.ConnectionStrings["default"].ConnectionString;
        ...
        private DataTable GetQueueResultTable(QueueSqlConfig quePageConfig, ConfigTable configTable, FormCollection collection) {
            ...
            if ((sqlPageConfig.TaskId == "306910") || (sqlPageConfig.TaskId == "306920") || (sqlPageConfig.TaskId == "306930") || (sqlPageConfig.TaskId == "306210") || (sqlPageConfig.TaskId == "306220") || (sqlPageConfig.TaskId == "306230") || (sqlPageConfig.TaskId == "309100") || (sqlPageConfig.TaskId == "306520"))
            {
            ...
            else if ((sqlPageConfig.TaskId == "308130") || (sqlPageConfig.TaskId == "308140") || (sqlPageConfig.TaskId == "308150") || (sqlPageConfig.TaskId == "308110") || (sqlPageConfig.TaskId == "308120") || (sqlPageConfig.TaskId == "306550") || (sqlPageConfig.TaskId == "308160")  || (sqlPageConfig.TaskId == "308170") || (sqlPageConfig.TaskId == "308180") || (sqlPageConfig.TaskId == "308190") || (sqlPageConfig.TaskId == "308200"))
            {
                ...
                using (DbConnection con = dbContext.Database.Connection)
                {
                    ...
                    foreach (DataField dataField in ConvertConfigTableToConfigList(configTable))
                    {
                        ...
                        if (!string.IsNullOrEmpty(dataField.ValueTextQueryForOption))
                        {
                            ...
                            else if (dataField.ValueTextQueryForOption.Contains("@fldIssueBranchCode"))
                            {
                                dataField.ValueTextQueryForOption = dataField.ValueTextQueryForOption.Replace("@fldIssueBranchCode", " ' "+ currentUserAccount.BranchCode + " ' ");
                            }
        ...
        private ResultPageViewModel WrapResultPage(DataTable resultTable, ConfigTable configTableModel, int currentPage) {
            ...
            if ((resultTable.Rows.Count > 0))
            {
                ...
                totalRecordperPage = resultTable.Columns.Contains("Records") ? Convert.ToInt32(resultTable.Rows[0]["Records"]) : 0;
                totalAmountperPage = resultTable.Columns.Contains("TotalAmount") ? (resultTable.Rows[0]["TotalAmount"].ToString() != "" ? Convert.ToDouble(resultTable.Rows[0]["TotalAmount"]) : 0) : 0;
                ...
                if (resultTable.Columns.Contains("Records")) resultTable.Columns.Remove("Records");
                //if (resultTable.Columns.Contains("TotalAmount")) resultTable.Columns.Remove("TotalAmount");
            }
            ...
            resultPage.TotalRecordperPage = totalRecordperPage;
            resultPage.TotalAmountperPage = totalAmountperPage;
                ...
                foreach (DataColumn item in resultTable.Columns) {
                    ...
                    dataField = (from data in dataList where string.Compare(data.fieldId, item.Caption) == 0 select data).FirstOrDefault();
                        ...
                        if (dataField.fieldType == "Date") {
                            ...
                            if (dataField.taskId == "999980" || dataField.taskId == "999830" || dataField.taskId == "999840" || dataField.taskId == "999850" || dataField.taskId == "999860" || dataField.taskId == "309124" || dataField.taskId == "309123")
                            {
        ...
        private DataTable GetResultTable(PageSqlConfig sqlPageConfig, ConfigTable configTable, FormCollection collection) {
            ...
            try
            {
                ...
                DataTable dt = dbContext.GetRecordsAsDataTable(sqlContainer.sql, sqlContainer.sqlParams.ToArray());
                return dt;
            }
            catch (Exception ex)
            {
