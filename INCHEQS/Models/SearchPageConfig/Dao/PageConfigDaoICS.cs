...
using INCHEQS.DataAccessLayer.ICS;
using INCHEQS.Common;



namespace INCHEQS.Models.SearchPageConfig {
    public class PageConfigDaoICS : IPageConfigDaoICS {

       // private string strConn = ConfigurationManager.ConnectionStrings["default"].ConnectionString;

        private readonly ICSDbContext dbContext;
        public PageConfigDaoICS(ICSDbContext dbContext) {
