                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            $.each(data, function (i, item) {
                                ...
                                $('#chequeImage').attr("src", $('#chequeImage').attr("src"));
                            });
                        },
                    });
...
function drawSignatureInformationTable(accountNo, $holder) {
    ...
    var signatureTableTemplate = [
        ...
        "<span style='margin-left:25px'>Name : </span><span id='signatureGroup'><%= i.sigGroup %></span>",
...
function markCarryForwardSignature(itemId) {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: App.ContextPath + "Signature/InsertAccount",
        data: "itemId=" + itemId,
        success: function (data) {
            $.each(data, function (i, item) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /*setTimeout(function () {
        ...
        //drawMainSignatureInformationType2();
    }, 800);*/ //Azim disabled
