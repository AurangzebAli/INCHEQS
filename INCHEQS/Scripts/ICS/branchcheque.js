...
(function () {
    ...
    var signatureTableTemplate = [
        ...
        //"</div>",
                        "<div class='pull-left signature-thumb'>",
                            "<a id='signature<%= item %>' class='signature-gallery-nav' value='<%= item %>' ",
    ...
    var signatureRulesInfoTemplate = [
        ...
        //"<% } %>",
        "<tr style='background-color:white'><th class='col-sm-4'>Name of Account</th><td colspan='3'> <input style='font-weight: bold; width: 100%; border: 1px solid blue; font-size:17px;' maxlength='250' onfocus='this.blur' value='<%= i.accName %>' readonly> </td></tr>",
        "<tr style='background-color:white'><th class='col-sm-4'>Account No</th><td> <input type='text' value='<%= i.accNo %>' style='font-weight: bold;color: black;border: 1px solid blue; font-size:17px;' readonly> </td>",
        "<th class='col-sm-2'>Status</th><td><input type='text' style='width:100%;font-weight: bold;color: black;border: 1px solid blue; font-size:17px;' value='<%= i.signatureStatus %>' readonly></td>",
        "</tr>",
        "<% }) %>"
    ].join("\n");
    ...
    var signatureRulesTableTemplate = [
        ...
        "<thead><tr style='background-color:white'><th colspan='2' style='font-weight: bold; padding: 2px; border-top: none; border-bottom: none;'>SIG CONDITIONS</th><td style='border-top: 1px solid #FFFFFF;border-bottom: 1px solid #FFFFFF'></td><th style='font-weight: bold;padding: 2px; border-top: none; border-bottom: none;'>MIN (RM)</th><th style='font-weight: bold;padding: 2px; border-top: none; border-bottom: none;'>MAX (RM)</th></tr>",
        "<% } %>",
        "<% var TmpRuleNo = 0; %>",
        "<% var SumReqSig = 0; %>",
        //"<% SumReqSig = 0; %>",
        ...
        "<tr style='background-color:white'><td style='border-top: 1px solid #FFFFFF'></td>",
        ...
        "<tr style='background-color:white'><td style='font-weight: bold;padding: 2px; border-top: none; border-bottom: none;'> RULE <%=i.RuleNo%>,</td>",
        "<td style='border-top: 1px solid #FFFFFF'></td>",
