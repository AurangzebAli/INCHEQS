...
(function () {
	...
	$(document).ready(function () {
		...
		$("#btnScan").on("click", function (e) {
			...
			if (scnControl.mLngRet == 0) {
				...
				if (strCaptureMode == "IR") {
				    ...
				    jsScanningItemConfig(strUIC, bEndorsement);
				}
				...
				do {
				    ...
				    //}
					//alert("??--intTotalCounter=" + intTotalCounter);
					//alert("??--MaxItemPerBatch=" + MaxItemPerBatch);
				...
				} while (scnControl.mLngRet >= 0 && intTotalCounter <= MaxItemPerBatch)
		...
		$("#btnRescan").on("click", function (e) {
			...
			jsScanningItemConfig(strUIC, 0);//use back the same UIC no.
		...
		function jsScanningItemConfig(strUIC, intEnableEndorsement) {
		    ...
		    scnControl.bEndorsement = intEnableEndorsement;
		    //alert("??--intEnableEndorsement=" + intEnableEndorsement);
		    //alert("??--scnControl.bEndorsement=" + scnControl.bEndorsement);
		    if (intEnableEndorsement = 1) {
		        scnControl.strEndorsementText = strUIC;
		    }
		    //alert("??--scnControl.strEndorsementText=" + scnControl.strEndorsementText);
		}
		...
		function jsGetAmtMyanmar(strInText) {
			...
			int1 = strInText.indexOf("x") + 1;
			int2 = strInText.indexOf("x", int1) + 1;
			if (int1 > 0 && intBOD - int1 > 14) {
				strResult = strInText.substr((int1 + 1) - 1, 14);
				strResult = jsVerifyField(strResult, "LR");
				return strResult;
			}
			else if (int1 > 0 && int1 < int2 && int2 - int1 - 1 > 0) {
				...
				strResult = strInText.substr((int1 - 14) - 1, 14);
				strResult = jsVerifyField(strResult, "RL");
				return strResult;
			}
			else {
